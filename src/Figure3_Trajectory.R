...
total_proprotions_across_groups.1.4weeks <- total_proprotions_across_groups.1[TimePoint_Final == "4wk post-CAR T"]
total_proprotions_across_groups.1.6months <- total_proprotions_across_groups.1[TimePoint_Final == "6mo post-CAR T"]
...
total_proprotions_across_groups.1.4weeks$Condition <- "4wk post-CAR T"
...
total_proprotions_across_groups.1.6months$Condition <- "6mo post-CAR T"
...
cd8.new2 <- setnames(data.frame(c("CD8 Tem/TGFb1+CXCR4+","CD8 Tem/PF4+", "CD8 Tem/PF4+", "CD8 Tem/Highly cytotoxic", "CD8 Tem/Highly cytotoxic"),
                                  c("4wk post-CAR T","4wk post-CAR T","4wk post-CAR T","4wk post-CAR T","4wk post-CAR T"),
                                  c("CD8 Tem/PF4+","CD8 Temra/senescent","CD8 MAIT","CD8 Tem/LLEC","CD8 Tex/Ki67+IRF4+")),
                       c("from","Condition","to"))
...
cd8.new3 <- setnames(data.frame(c("CD8 Tem/TGFb1+CXCR4+","CD8 Tem/PF4+", "CD8 Tem/PF4+", "CD8 Tem/Highly cytotoxic", "CD8 Tem/Highly cytotoxic"),
                                  c("6mo post-CAR T","6mo post-CAR T","6mo post-CAR T","6mo post-CAR T","6mo post-CAR T"),
                                  c("CD8 Tem/PF4+","CD8 Temra/senescent","CD8 MAIT","CD8 Tem/LLEC","CD8 Tex/Ki67+IRF4+")),
                       c("from","Condition","to"))
...
cd8.4weeks.relapsed <- cd8[Condition == "4wk post-CAR T"]
cd8.4weeks.relapsed$FC <- cd8.4weeks.relapsed$FC_Responders_vs_Relapsed
cd8.4weeks.relapsed <- plot_graph(cd8.4weeks.relapsed,c(min(cd8$FC_Responders_vs_Relapsed), max(cd8$FC_Responders_vs_Relapsed)), "4wk post-CAR T")


cd8.6months.relapsed <- cd8[Condition == "6mo post-CAR T"]
cd8.6months.relapsed$FC <- cd8.6months.relapsed$FC_Responders_vs_Relapsed
cd8.6months.relapsed <- plot_graph(cd8.6months.relapsed,c(min(cd8$FC_Responders_vs_Relapsed),max(cd8$FC_Responders_vs_Relapsed)),"6mo post-CAR T")
...
cd8.leukapheresis.Nonresponder <- plot_graph(cd8.leukapheresis.Nonresponder,c(min(cd8[Condition == "Leukapheresis"|Condition == "4wk post-CAR T"]$FC_Responders_vs_nonResponders),
                                                                              max(cd8[Condition == "Leukapheresis"|Condition == "4wk post-CAR T"]$FC_Responders_vs_nonResponders)), "Leukapheresis")


cd8.4weeks.Nonresponder <- cd8[Condition == "4wk post-CAR T"]
cd8.4weeks.Nonresponder$FC <- cd8.4weeks.Nonresponder$FC_Responders_vs_nonResponders
cd8.4weeks.Nonresponder <- plot_graph(cd8.4weeks.Nonresponder,c(min(cd8[Condition == "Leukapheresis"|Condition == "4wk post-CAR T"]$FC_Responders_vs_nonResponders),
                                                                max(cd8[Condition == "Leukapheresis"|Condition == "4wk post-CAR T"]$FC_Responders_vs_nonResponders)), "4wk post-CAR T")
...
cd4.new2 <- setnames(data.frame(c("CD4 Th2/Th17","CD4 Teh/TCF7+LEF1+","CD4 Th1","CD4 Th1","CD4 Th1","CD4 Th2","CD4 Th2"),
                                  c("4wk post-CAR T","4wk post-CAR T","4wk post-CAR T","4wk post-CAR T","4wk post-CAR T","4wk post-CAR T","4wk post-CAR T"),
                                  c("CD4 Th17/BCL6+","CD4 Th2/Th17","CD4 Teh/TNF+","CD4 CTL","CD4 Tex/Ki67+","CD4 Tem/Teh","CD4 Teh/PF4+")),
                       c("from","Condition","to"))

cd4.new3 <- setnames(data.frame(c("CD4 Th2/Th17","CD4 Teh/TCF7+LEF1+","CD4 Th1","CD4 Th1","CD4 Th1","CD4 Th2","CD4 Th2"),
                                  c("6mo post-CAR T","6mo post-CAR T","6mo post-CAR T","6mo post-CAR T","6mo post-CAR T","6mo post-CAR T","6mo post-CAR T"),
                                  c("CD4 Th17/BCL6+","CD4 Th2/Th17","CD4 Teh/TNF+","CD4 CTL","CD4 Tex/Ki67+","CD4 Tem/Teh","CD4 Teh/PF4+")),
                       c("from","Condition","to"))
...
cd4.4weeks.relapsed <- cd4[Condition == "4wk post-CAR T"]
cd4.4weeks.relapsed$FC <- cd4.4weeks.relapsed$FC_Responders_vs_Relapsed
cd4.4weeks.relapsed <- plot_graph(cd4.4weeks.relapsed,c(min(cd4$FC_Responders_vs_Relapsed),max(cd4$FC_Responders_vs_Relapsed)), "4wk post-CAR T")


cd4.6months.relapsed <- cd4[Condition == "6mo post-CAR T"]
cd4.6months.relapsed$FC <- cd4.6months.relapsed$FC_Responders_vs_Relapsed
cd4.6months.relapsed <- plot_graph(cd4.6months.relapsed, c(min(cd4$FC_Responders_vs_Relapsed),max(cd4$FC_Responders_vs_Relapsed)),"6mo post-CAR T")
...
cd4.leukapheresis.Nonresponder <- plot_graph(cd4.leukapheresis.Nonresponder,c(min(cd4[Condition == "Leukapheresis"|Condition == "4wk post-CAR T"]$FC_Responders_vs_nonResponders),
                                                                                       max(cd4[Condition == "Leukapheresis"|Condition == "4wk post-CAR T"]$FC_Responders_vs_nonResponders)), "Leukapheresis")


cd4.4weeks.Nonresponder <- cd4[Condition == "4wk post-CAR T"]
cd4.4weeks.Nonresponder$FC <- cd4.4weeks.Nonresponder$FC_Responders_vs_nonResponders
cd4.4weeks.Nonresponder <- plot_graph(cd4.4weeks.Nonresponder,c(min(cd4[Condition == "Leukapheresis"|Condition == "4wk post-CAR T"]$FC_Responders_vs_nonResponders),
                                                                         max(cd4[Condition == "Leukapheresis"|Condition == "4wk post-CAR T"]$FC_Responders_vs_nonResponders)), "4wk post-CAR T")
